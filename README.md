...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uproot3-methods-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11805&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/uproot3-methods-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uproot3-methods` can be installed with:

```
conda install uproot3-methods
```

It is possible to list all of the versions of `uproot3-methods` available on your platform with:
